          ...
          {filteredUsers.sort((a,b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()).map((user) => (
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                {/* Right container for action icons - always pinned to the right */}
                <div className="flex items-center space-x-1 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0 ml-3">
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      handleEdit(user);
