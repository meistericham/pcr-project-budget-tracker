...
const UserModal: React.FC<UserModalProps> = ({ user, onClose }) => {
  ...
  const { refreshCurrentUser, user: currentUser, profile } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (user) {
      try {
        ...
        // Note: Password changes are now handled via invite-by-email flow
      ...
      try {
        // Create user via invite-by-email
